...
const benefits: SplitFeature[] = [
  {
    title: "Effortless Scaling",
    body: "Grow from a single page to a full site without friction.",
    icon: (
      <path
  ...
  {
    title: "Built to Last",
    body: "Solid foundations that stay relevant for years.",
    icon: (
      <path
...
export function BenefitsSection() {
  return (
    <SplitFeatureSection
      image={`${CDN}/AboutBgreenhouse.webp`}
      caption="Designed for clarity and calm"
      eyebrow="Why Hopeward"
      heading="Benefits that compound over time"
      body="Every layout, interaction, and component is crafted to reduce friction — so you spend less time fighting your tools and more time telling your story. Clean structure, thoughtful motion, and modular building blocks keep your site adaptable as you grow."
