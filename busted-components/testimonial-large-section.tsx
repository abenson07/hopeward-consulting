import {
  SplitFeatureSection,
  type SplitFeature,
} from "@/busted-components/split-feature-section";

const CDN = "https://byqsupply-components.netlify.app/evermind/images";

const proofPoints: SplitFeature[] = [
  {
    title: "8x faster launch",
    body: "Teams ship polished sites in a fraction of the time.",
    icon: (
      <path
  ...
  },
  {
    ...
    body: "From solo founders to growing agencies.",
    icon: (
      <path
...
export function TestimonialLargeSection() {
  return (
    <SplitFeatureSection
      image={`${CDN}/TestimonialImage.webp`}
      caption="Franco Build — Customer story"
      eyebrow="Customer Story"
      heading="“We approached Hopeward looking for something flexible yet timeless.”"
      body="What we got was a system that scaled with our mission. The modular layouts and thoughtful details let our small team move like a much larger one — turning blueprints into a living brand story in record time."
      ctaLabel="Read case study"
      features={proofPoints}
    />
  );
}
